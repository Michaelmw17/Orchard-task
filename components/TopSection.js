      ...
      <div className="">
        <div className="container m-auto w-100 px-2 text-gray-600 md:px-0 xl:px-0">
          <div className="grid gap-0 md:ml-16  lg:grid-cols-2">
            <div className="p-12 pl-2 pr-12 md:pr-0 gap-2 mr-8 rounded-xl group flex space-x-2 hover:rounded-2xl">
            ...
            <div className="md:w-12/12 sm:w-10/12 pl-0 p-10 p-5 pt-0 md:pt-4">
